...
const AVATAR_PRESETS = [
  ...
  { id: "mandragora", label: "Mandragora", url: "https://eog.gg/assets/sxs/fantomons/mandragora.webp", desc: "SR · When a Technique is used on allies, heals 1 target once. Flying Leaf deals Wind DMG once to 1 enemy within 4 grids. Wakening of Vitality heals 1 ally (caster excluded) within 4 grids once." },
  { id: "herbote",    label: "Herbote",    url: "https://eog.gg/assets/sxs/fantomons/herbote.webp",    desc: "SSR · If the caster starts a turn with HP below 80%, heals the caster once, with a 50% chance to randomly dispel 1 status ailment or debuff. Quick Fix heals 1 ally within 2 grids. Cure All heals the owner within 2 grids and grants 1 random buff (+10% ATK, +10% DEF, or +10% SPD) for 1 turn." },
